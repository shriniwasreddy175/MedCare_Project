      ...
      <div className="nurse-main-content">
        ...
        <div className="patient-list-container">
          {filteredPatients
            ...
            <div
              key={patient.id}
              className={`patient-card ${patient.hasAlert ? 'alert-card' : ''}`}
            >
              <div className="patient-card-content">
                <div className="patient-info-section">
                  ...
                  <div>
                    <div className="flex-center">
                      ...
                      {patient.isPregnant && (
                        <div className="badge badge-pink">
                          <Baby className="icon-xs" />
                          {patient.pregnancyWeek}w
                        </div>
                      )}
                      {patient.hasAlert && (
                        <div className={`badge ${
                          patient.alertLevel === 'nurse' ? 'badge-red' : 'badge-orange'
                        }`}>
                    ...
                    <p className="patient-meta">Age {patient.age} • {patient.gender}</p>
                    <div className="flex-center text-sm text-gray-500 mt-1">
                      <MapPin className="icon-xs" />
                      <span>{patient.location}</span>
                    </div>
                    {patient.alertTime && (
                      <div className="flex-center text-sm text-red-600 mt-1">
                        <Clock className="icon-xs" />
                        <span>Alert at {patient.alertTime}</span>
                      </div>
                    )}
                  </div>
                </div>
